...
* @version v1.0
* @date 2025-09-05
* @description 题集题目检测结果任务库 编辑参数
*/
@Data
@Schema(name = "ProSetSimilarityDetail", description = "题集题目检测结果任务库 编辑参数")
public class ProSetSimilarityDetailEditParam implements Serializable {
    @Serial
