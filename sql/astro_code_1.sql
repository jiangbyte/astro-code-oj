...
(
    ...
    `case_sign`        VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '用例标识',
    `input_data`       LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci     NULL COMMENT '输入数据',
    `output_data`      LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci     NULL COMMENT '输出数据',
    `expected_output`  LONGTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci     NULL COMMENT '期望输出',
    `input_file_path`  VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '输入文件路径',
    `input_file_size`  BIGINT                                                        NULL DEFAULT 0 COMMENT '输入文件大小',
    `output_file_path` VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '输出文件路径',
    `output_file_size` BIGINT                                                        NULL DEFAULT 0 COMMENT '输出文件大小',
    `max_time`         DECIMAL(10, 2)                                                NULL DEFAULT 0.00 COMMENT '最大耗时',
    `max_memory`       DECIMAL(10, 2)                                                NULL DEFAULT 0.00 COMMENT '最大内存使用',
    `is_sample`        TINYINT(1)                                                    NULL DEFAULT 0 COMMENT '是否样例判题',
    `score`            DECIMAL(10, 2)                                                NULL DEFAULT 0.00 COMMENT '分值',
    ...
    `exit_code`        INT                                                           NULL DEFAULT 0 COMMENT '退出码',
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT = '判题结果用例表'
  ROW_FORMAT = DYNAMIC;
...
(
    ...
    `output_file_path` VARCHAR(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '输出文件路径',
    `output_file_size` BIGINT                                                        NULL DEFAULT 0 COMMENT '输出文件大小',
    `is_sample`        TINYINT(1)                                                    NULL DEFAULT 0 COMMENT '是否样例',
    `score`            DECIMAL(10, 2)                                                NULL DEFAULT 0.00 COMMENT '分值',
    `deleted`          TINYINT(1)                                                    NULL DEFAULT 0 COMMENT '删除状态',
    `create_time`      DATETIME                                                      NULL DEFAULT NULL COMMENT '创建时间戳',
    `create_user`      VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL DEFAULT NULL COMMENT '创建者',
...
VALUES ('1982136140003225601', 'Admin端登录背景', 'APP_ADMIN_LOGIN_BACKGROUND', 'http://120.26.180.149:9000/astro-code-oj/043d6be2e9c6415798985a3dc991754f.jpg', '6', '登录页面背景图片', 0,
        '2025-10-21 12:25:12', '1', '2025-10-24 09:01:10', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225602', 'Web端登录背景', 'APP_PC_LOGIN_BACKGROUND', 'https://upload-bbs.miyoushe.com/upload/2024/07/11/292762008/54cbcd3b61a7d6cc4b194d5c48236b4a_8421561160147429361.jpg', '6',
        'Web应用端登录背景', 0, '2025-10-21 12:25:12', '1', '2025-10-24 09:00:26', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225603', 'Web端注册背景', 'APP_PC_REGISTER_BACKGROUND', 'https://upload-bbs.miyoushe.com/upload/2024/07/09/247364438/dbeba8ef3d93a4b86b74c080010e3f5e_8407127069598351562.jpg',
        '6', 'Web应用端注册背景', 0, '2025-10-21 12:25:12', '1', '2025-10-24 09:00:31', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225604', 'Web端显示名称', 'APP_PC_SHOW_APP_NAME', 'false', '1', 'false 显示 Logo，true 显示 名称', 0, '2025-10-21 12:25:12', '1', '2025-10-24 09:00:15', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225605', '用户默认头像', 'APP_DEFAULT_AVATAR', 'http://120.26.180.149:9000/astro-code-oj/85db17abd2f145a1aa0f4a487866e18e.png', '6', '', 0, '2025-10-21 12:25:12', '1',
        '2025-10-24 11:54:09', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225606', '用户默认背景', 'APP_DEFAULT_USER_BACKGROUND', 'http://120.26.180.149:9000/astro-code-oj/b21583960cad4fe98ebc533e9153303f.jpg', '6', '', 0, '2025-10-21 12:25:12', '1',
        '2025-10-24 09:00:50', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225607', '2.应用Logo', 'APP_LOGO', 'http://120.26.180.149:9000/astro-code-oj/1be69ed211b44bedab9b487ddea8d84d.png', '6', '建议 1:1 图片上传', 0, '2025-10-21 12:25:12', '1',
        '2025-10-24 11:48:40', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225608', '1.应用名称', 'APP_NAME', 'Astro Code', '2', '应用名称', 0, '2025-10-21 12:25:12', '1', '2025-10-24 11:45:24', '1', '5', 0);
INSERT INTO `sys_config`
VALUES ('1982136140003225609', 'Admin端显示名称', 'APP_ADMIN_SHOW_APP_NAME', 'false', '1', '', 0, '2025-10-21 12:25:12', '1', '2025-10-24 09:01:27', '1', '5', 0);
...
INSERT INTO `sys_menu`
VALUES ('1979358311883591681', '0', 'outweb_index', '/outweb', NULL, '外部管理', 'icon-park-outline:application-two', 0, 1, 14, 0, 0, '[]', 0, '2025-10-21 12:25:12', '1', '2025-10-22 12:25:12', '1',
        NULL);
INSERT INTO `sys_menu`
VALUES ('1979359157794377729', '1979358311883591681', 'nacos', '/outweb/nacos', '/outweb/nacos.vue', 'Nacos', 'icon-park-outline:setting-config', 0, 0, 2, 0, 1, '[]', 1, '2025-10-21 12:25:12', '1',
        '2025-10-22 12:25:12', '1', NULL);
INSERT INTO `sys_menu`
VALUES ('1979359562444050434', '1979358311883591681', 'dozzle120', '/outweb/dozzle120', '/outweb/index.vue', '120服务器日志', 'icon-park-outline:log', 0, 1, 3, 1, 1, '[]', 0, '2025-10-21 12:25:12',
        '1', '2025-10-24 12:00:50', '1', '{\n    \"href_inner\": \"http://120.26.180.149:9001/\"\n}');
INSERT INTO `sys_menu`
VALUES ('1979779968216379394', '1979358311883591681', 'dozzle47', '/outweb/dozzle47', '/outweb/index.vue', '47服务器日志', 'icon-park-outline:log', 0, 1, 2, 1, 1, '[]', 0, '2025-10-21 12:25:12', '1',
        '2025-10-24 12:00:45', '1', '{\r\n    \"href_inner\": \"http://47.99.236.69:9001/\"\r\n}');
INSERT INTO `sys_menu`
VALUES ('1979781411367333889', '1979358311883591681', 'portainer', '/outweb/portainer', '/outweb/index.vue', 'Portainer', 'icon-park-outline:application', 0, 1, 4, 1, 1, '[]', 0,
        '2025-10-21 12:25:12', '1', '2025-10-24 12:00:55', '1', '{\r\n    \"href_inner\": \"http://101.201.174.43:9020/\"\r\n}');
INSERT INTO `sys_menu`
VALUES ('1979784519254323202', '1979358311883591681', 'nacos', '/outweb/nacos', '/outweb/index.vue', 'Nacos', 'icon-park-outline:link-cloud', 0, 1, 5, 0, 1, '[]', 0, '2025-10-21 12:25:12', '1',
        '2025-10-24 12:01:43', '1', '{\r\n    \"href_outter\": \"http://120.26.180.149:8848/nacos\"\r\n}');
INSERT INTO `sys_menu`
VALUES ('1979788036882870274', '1979358311883591681', 'minio', '/outweb/minio', '/outweb/index.vue', 'Minio', 'icon-park-outline:file-cabinet', 0, 1, 6, 0, 1, '[]', 0, '2025-10-21 12:25:12', '1',
        '2025-10-24 12:01:50', '1', '{\r\n    \"href_outter\": \"http://120.26.180.149:9090/\"\r\n}');
INSERT INTO `sys_menu`
VALUES ('1979792211910332418', '1979358311883591681', 'dozzle101', '/outweb/dozzle101', '/outweb/index.vue', '101服务器日志', 'icon-park-outline:log', 0, 1, 1, 1, 1, '[]', 0, '2025-10-21 12:25:12',
        '1', '2025-10-24 12:00:40', '1', '{\r\n    \"href_inner\": \"http://101.201.174.43:9995/\"\r\n}');
INSERT INTO `sys_menu`
...
INSERT INTO `sys_menu`
VALUES ('701', '0', 'report', '/visualization/submit/report/:reportId/task/:taskId', '/modular/visualization/submit/report.vue', '报告可视化', 'icon-park-outline:info', 0, 0, 99, 0, 1, NULL, 0,
        '2025-10-21 12:25:12', '1', '2025-10-22 12:25:12', '1', NULL);
...
VALUES ('1', '108');
INSERT INTO `sys_role_menu`
VALUES ('1', '1980094089497628673');
INSERT INTO `sys_role_menu`
VALUES ('1', '1980165871264997378');
INSERT INTO `sys_role_menu`
VALUES ('1', '1979359562444050434');
INSERT INTO `sys_role_menu`
VALUES ('1', '1979779968216379394');
INSERT INTO `sys_role_menu`
VALUES ('1', '1979781411367333889');
INSERT INTO `sys_role_menu`
VALUES ('1', '1979784519254323202');
INSERT INTO `sys_role_menu`
VALUES ('1', '1979788036882870274');
INSERT INTO `sys_role_menu`
VALUES ('1', '1979792211910332418');
INSERT INTO `sys_role_menu`
VALUES ('2', '1');
INSERT INTO `sys_role_menu`
VALUES ('2', '100');
...
VALUES ('2', '108');
INSERT INTO `sys_role_menu`
VALUES ('2', '1980094089497628673');
INSERT INTO `sys_role_menu`
VALUES ('2', '1980165871264997378');
INSERT INTO `sys_role_menu`
VALUES ('4', '1');
INSERT INTO `sys_role_menu`
VALUES ('4', '600');
...
VALUES ('0', '1', 'default', '$2a$10$CGf0BGdflI3iG6Fl83Vjz.kE.XdhMSu.sstPIeNI.9WFz8FR/lmS.', 'Astro Code', NULL, NULL, NULL, 0, 'default@163.com', NULL, NULL, NULL, 0, '2025-10-21 12:25:12', '1',
        '2025-10-22 12:25:12', '1');
INSERT INTO `sys_user`
VALUES ('1', '2', 'superadmin', '$2a$10$hS6E7n8tqGZMX2qOzLyk2.pospgtnLo.8gjXAtfttGruIh9AE2lgG', 'SuperAdmin', NULL, NULL, NULL, 1, 'superadmin@163.com', NULL, NULL, '2025-10-26 12:30:35', 0,
        '2025-10-21 12:25:12', '1', '2025-10-26 12:30:35', '1');
INSERT INTO `sys_user`
VALUES ('2', '3', 'adminadmin', '$2a$10$hS6E7n8tqGZMX2qOzLyk2.pospgtnLo.8gjXAtfttGruIh9AE2lgG', 'Admin', NULL, NULL, NULL, 0, 'adminadmin@163.com', NULL, NULL, '2025-10-07 13:20:00', 0,
        '2025-10-21 12:25:12', '1', '2025-10-22 12:25:12', '1');
