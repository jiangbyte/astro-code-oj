...
(
    ...
    `case_sign`        VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '用例标识',
    `input_data`       LONGTEXT                                                      NULL COMMENT '输入数据',
    `expected_output`  LONGTEXT                                                      NULL COMMENT '期望输出',

    `input_file_path`  VARCHAR(500)                                                  NULL COMMENT '输入文件路径',
    ...
    `score`            DECIMAL(10, 2)                                                NULL DEFAULT 0 COMMENT '分值',
    `deleted`          TINYINT(1)                                                    NULL DEFAULT 0 COMMENT '删除状态',
    `create_time`      DATETIME                                                      NULL DEFAULT NULL COMMENT '创建时间戳',
    `create_user`      VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NULL DEFAULT NULL COMMENT '创建者',
    `update_time`      DATETIME                                                      NULL DEFAULT NULL COMMENT '更新时间戳',
...
(
    ...
    `input_data`       LONGTEXT                                                     NULL COMMENT '输入数据',
    `output_data`      LONGTEXT                                                     NULL COMMENT '输出数据',
    `expected_output`  LONGTEXT                                                     NULL COMMENT '期望输出',
    ...
    `max_time`         DECIMAL(10, 2)                                               NULL DEFAULT 0 COMMENT '最大耗时',
    `max_memory`       DECIMAL(10, 2)                                               NULL DEFAULT 0 COMMENT '最大内存使用',
