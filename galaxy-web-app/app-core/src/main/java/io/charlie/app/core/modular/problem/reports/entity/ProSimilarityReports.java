package io.charlie.app.core.modular.problem.reports.entity;
...
@Data
@TableName(value = "pro_similarity_reports", autoResultMap = true)
@Schema(name = "ProSimilarityReports", description = "题目报告库表")
public class ProSimilarityReports extends CommonEntity {
    @Serial
