...
//    // 判题队列绑定
//    @Bean
//    public Binding problemSimilarityJudgeBinding(DirectExchange problemSimilarityJudgeExchange,
//                                                 Queue problemSimilarityJudgeQueue) {
//        log.info("Binding queue {} to exchange {} with routing key {}", QUEUE, EXCHANGE, ROUTING_KEY);
