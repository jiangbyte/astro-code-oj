...
* @version v1.0
* @date 2025-07-25
* @description 代码相似度检测结果详情 增加参数
*/
@Data
@Schema(name = "ProSimilarityResult", description = "代码相似度检测结果详情 增加参数")
public class ProSimilarityResultAddParam implements Serializable {
    @Serial
