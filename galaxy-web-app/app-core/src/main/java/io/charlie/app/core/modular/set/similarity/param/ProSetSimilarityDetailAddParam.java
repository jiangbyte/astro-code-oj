...
* @version v1.0
* @date 2025-09-05
* @description 题集题目检测结果任务库 增加参数
*/
@Data
@Schema(name = "ProSetSimilarityDetail", description = "题集题目检测结果任务库 增加参数")
public class ProSetSimilarityDetailAddParam implements Serializable {
    @Serial
