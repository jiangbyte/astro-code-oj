...
* @version v1.0
* @date 2025-09-08
* @description 题库题目报告库 增加参数
*/
@Data
@Schema(name = "ProSetSimilarityReports", description = "题库题目报告库 增加参数")
public class ProSetSimilarityReportsAddParam implements Serializable {
    @Serial
