package io.charlie.app.core.modular.set.similarity.entity;
...
@Data
@TableName(value = "pro_set_similarity_detail", autoResultMap = true)
@Schema(name = "ProSetSimilarityDetail", description = "题集题目检测结果任务库")
public class ProSetSimilarityDetail extends CommonEntity {
    @Serial
