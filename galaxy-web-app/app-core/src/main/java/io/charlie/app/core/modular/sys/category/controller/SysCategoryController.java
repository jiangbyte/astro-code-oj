package io.charlie.app.core.modular.sys.category.controller;
...
public class SysCategoryController {
    ...
    public Result<?> delete(@RequestBody @Valid @NotEmpty(message = "集合不能为空") List<SysCategoryIdParam> sysCategoryIdParams) {
        sysCategoryService.delete(sysCategoryIdParams);
        return Result.success();
    }
