...
import io.charlie.app.core.modular.similarity.language.golang.GoLexer;
import io.charlie.app.core.modular.similarity.language.golang.GoParser;
 ...
 */
@Slf4j
@Component("golangLanguageStrategy")
