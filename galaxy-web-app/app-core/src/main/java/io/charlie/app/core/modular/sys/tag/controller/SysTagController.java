package io.charlie.app.core.modular.sys.tag.controller;
...
public class SysTagController {
    ...
    public Result<?> delete(@RequestBody @Valid @NotEmpty(message = "集合不能为空") List<SysTagIdParam> sysTagIdParams) {
        sysTagService.delete(sysTagIdParams);
        return Result.success();
    }
