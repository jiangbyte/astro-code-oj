package io.charlie.app.core.modular.group.service.impl;
...
import io.charlie.app.core.modular.group.entity.SysGroup;
import io.charlie.app.core.modular.group.param.SysGroupAddParam;
import io.charlie.app.core.modular.group.param.SysGroupEditParam;
import io.charlie.app.core.modular.group.param.SysGroupIdParam;
import io.charlie.app.core.modular.group.param.SysGroupPageParam;
import io.charlie.app.core.modular.group.mapper.SysGroupMapper;
import io.charlie.app.core.modular.group.service.SysGroupService;
...
public class SysGroupServiceImpl extends ServiceImpl<SysGroupMapper, SysGroup> implements SysGroupService {
    ...
    public Page<SysGroup> page(SysGroupPageParam sysGroupPageParam) {
        ...
        if (ObjectUtil.isNotEmpty(sysGroupPageParam.getKeyword())) {
            queryWrapper.lambda().like(SysGroup::getTitle, sysGroupPageParam.getKeyword());
        }
