package io.charlie.app.core.modular.user.service.impl;
...
import io.charlie.app.core.modular.user.service.SysUserService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public Page<SysUser> page(SysUserPageParam sysUserPageParam) {
        ...
        if (ObjectUtil.isNotEmpty(sysUserPageParam.getKeyword())) {
            queryWrapper.lambda().like(SysUser::getUsername, sysUserPageParam.getKeyword());
        }
