package io.charlie.app.core.modular.config.service.impl;
...
import io.charlie.app.core.modular.config.mapper.SysConfigMapper;
import io.charlie.app.core.modular.config.service.SysConfigService;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements SysConfigService {
    ...
    public Page<SysConfig> page(SysConfigPageParam sysConfigPageParam) {
        ...
        if (ObjectUtil.isNotEmpty(sysConfigPageParam.getKeyword())) {
            queryWrapper.lambda().like(SysConfig::getTitle, sysConfigPageParam.getKeyword());
        }
        if (ObjectUtil.isAllNotEmpty(sysConfigPageParam.getSortField(), sysConfigPageParam.getSortOrder()) && ISortOrderEnum.isValid(sysConfigPageParam.getSortOrder())) {
            ...
            queryWrapper.lambda().orderByAsc(SysConfig::getSort);
        }
