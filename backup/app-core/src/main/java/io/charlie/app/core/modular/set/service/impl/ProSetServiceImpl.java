...
import io.charlie.app.core.modular.set.mapper.ProSetMapper;
...
public class ProSetServiceImpl extends ServiceImpl<ProSetMapper, ProSet> implements ProSetService {
    ...
    public ProSet detail(ProSetIdParam proSetIdParam) {
        return this.queryEntity(proSetIdParam.getId());
    }

    @Override
    public ProSet queryEntity(String id) {
        ProSet proSet = this.getById(id);
