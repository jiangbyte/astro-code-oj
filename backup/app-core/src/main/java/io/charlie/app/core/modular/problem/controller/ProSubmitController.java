package io.charlie.app.core.modular.problem.controller;
...
public class ProSubmitController {
    ...
    //@SaCheckPermission("/pro/submit/exec")
    @PostMapping("/pro/submit/exec")
    public Result<?> executeCode(@RequestBody @Valid ProSubmitExecParam proSubmitExecParam) {
        return Result.success(proSubmitService.executeCode(proSubmitExecParam));
    }
}