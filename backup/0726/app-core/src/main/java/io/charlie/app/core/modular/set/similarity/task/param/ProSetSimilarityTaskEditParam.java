...
* @version v1.0
* @date 2025-07-25
* @description 题单代码相似度检测任务 编辑参数
*/
@Data
@Schema(name = "ProSetSimilarityTask", description = "题单代码相似度检测任务 编辑参数")
public class ProSetSimilarityTaskEditParam implements Serializable {
    @Serial
