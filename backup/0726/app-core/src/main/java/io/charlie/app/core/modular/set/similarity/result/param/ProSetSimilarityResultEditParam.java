...
* @version v1.0
* @date 2025-07-25
* @description 题单代码相似度检测结果详情 编辑参数
*/
@Data
@Schema(name = "ProSetSimilarityResult", description = "题单代码相似度检测结果详情 编辑参数")
public class ProSetSimilarityResultEditParam implements Serializable {
    @Serial
