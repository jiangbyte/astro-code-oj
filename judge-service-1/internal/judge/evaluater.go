...
// // 创建执行器，传入上下文，沙箱
// func NewEvaluater(ctx context.Context, sandbox Sandbox, resultData *dto.JudgeResponse, svcCtx *svc.ServiceContext) *Evaluater {
// 	return &Evaluater{
// 		ctx:     ctx,
// 		Sandbox: sandbox,
// 		result:  resultData,
...
// // 实际执行
// func (e *Evaluater) Execute() (*dto.JudgeResponse, error) {
// 	maxTime := 0.0
// 	maxMemory := 0.0
