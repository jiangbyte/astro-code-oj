...
import { useProblemRankingFetch } from '@/composables'

const { problemRankingPage } = useProblemRankingFetch()
...
async function loadData() {
  const { data: totalRankingPage } = await problemRankingPage(totalRankingPageParam.value)
  if (totalRankingPage) {
