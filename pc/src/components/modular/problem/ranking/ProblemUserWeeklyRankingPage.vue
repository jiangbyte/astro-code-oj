...
const { problemUserWeeklyRankingPage: problemWeeklyRankingPage } = useProblemUserRankingFetch()
...
async function loadData() {
  const { data: totalRankingPage } = await problemWeeklyRankingPage(totalRankingPageParam.value)
  if (totalRankingPage) {
