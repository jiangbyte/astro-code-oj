...
const { problemUserDailyRankingPage: problemDailyRankingPage } = useProblemUserRankingFetch()
...
async function loadData() {
  const { data: totalRankingPage } = await problemDailyRankingPage(totalRankingPageParam.value)
  if (totalRankingPage) {
