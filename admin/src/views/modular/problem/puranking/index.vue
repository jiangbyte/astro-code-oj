...
import { NAvatar, NButton, NCard, NDataTable, NPagination, NSpace, NText } from 'naive-ui'
...
const { problemUserTotalRankingPage } = useProblemUserRankingFetch()
const loading = ref(false)
async function loadData() {
  loading.value = true
  const { data } = await problemUserTotalRankingPage(pageParam.value)
  if (data) {
    pageData.value = data
    loading.value = false
  }
